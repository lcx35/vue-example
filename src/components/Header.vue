<template>
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <router-link to="/" class="navbar-brand">SAweb</router-link>
      <ul class="navbar-nav">
      ...
      <ul class="navbar-nav ml-auto">
        <li>
          <router-link :to="{name:'loginLink'}" v-show="!Login" class="nav-link">登录</router-link>
        </li>
        <li class="nav-link">{{User}}</li>
        <li>
          <a @click="quit()" v-show="Login" class="nav-link">[退出]</a>
          <!-- <router-link @click="quit()" :to="{name:'loginLink'}" v-show="Login" class="nav-link">[退出]</router-link> -->
        </li>
        <li>
          <router-link :to="{name:'registerLink'}" v-show="!Login" class="nav-link">注册</router-link>
        </li>
      </ul>
    </nav>
  </header>
...
export default {
  ...
  methods:{
    quit(){
      this.$store.dispatch("quit",false)
    }
  }
}
</script>
